...
export class ChatAnthropic extends BaseChatModel {
    ...
    async createStreamWithRetry(request) {
        ...
        const makeCompletionRequest = async () => this.streamingClient.completions.create({ ...request, stream: true });
    ...
    async completionWithRetry(request, options) {
        ...
        const makeCompletionRequest = async () => this.batchClient.completions.create({ ...request, stream: false });
